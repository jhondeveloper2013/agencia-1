    ...
    def post(self, request, format=None):
        ...
        try:
            send_mail(
                ...
                + '\nPhone: ' + phone
                + '\n\nBudget: ' + budget,
                'jcorrea@crossmediahost.com',# Correo del remitente
                ['jcorrea@crossmediahost.com'],# Lista de correos destinatarios
                fail_silently=False
            )
            #con esto lo guardamos en la BD
...
class OptInView(APIView):
    ...
    def post(self, request, format=None):
        ...
        try:
            ...
            #se crea el contact si el status es exitoso
            contact = response.json()

            try:
                #entro al contact.id para obtener el id que es un número y lo convierto a String
