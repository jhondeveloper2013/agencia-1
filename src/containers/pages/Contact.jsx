...
function Contact(){
    ...
    return (
     ...
     <label htmlFor="price" className="sr-only">Phone</label>
      <div className="relative mt-1 rounded-md shadow-sm">
        ...
        />
                  ...
                  <div>
                    ...
                    value={budget}
                    onChange={e=>onChange(e)}
                    className="mt-1 block w-full pl-3 pr-10 py-4 rounded-md text-base border border-gray-300 text-gray-500"
                    >
                    <option value="" className="text-gray-400">Select a budget (Optional)</option>
                    <option value="0-5k" className="text-gray-600">$0 - $5,000</option>
                    <option value="5-10k" className="text-gray-600">$5,000 - $10,000</option>
                    <option value="10-25k" className="text-gray-600">$10,000+</option>
                    </select>
                  </div>
